...
class detailedService(models.Model):
    ...
    service_CreateDate=models.DateTimeField(blank=True, null=True,default=timezone.now)
    service_ToBeDate=models.DateTimeField(blank=True, null=True, default=timezone.now)
